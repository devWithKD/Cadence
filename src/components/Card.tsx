...
const Card = memo(function Card({ id }: { id: string }) {
  ...
  return (
    <div
      className={`group/card box-border ast:mb-2 secondary-text rounded-lg bg-slate-200 dark:bg-slate-700 border border-slate-300 dark:border-slate-700 shadow shadow-slate-400 dark:shadow-slate-700 text-sm  mx-2 select-none cursor-pointer hover:border-2 hover:border-sky-600 dark:hover:border-blue-400 transition duration-300 flex flex-col relative ${
